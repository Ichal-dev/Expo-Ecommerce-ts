  ...
  render() {
    return (
      <SafeAreaView style={style.container}>
        ...
        <Line />
          <TouchableOpacity style={style.wrapperContent} onPress={() => this.props.navigation.navigate("Profile")}>
            <MaterialCommunityIcons name="account" size={24} color={COLOR_PRIMARY_BLUE} />
        ...
        <View style={style.wrapperContent}>
          <Ionicons name="location-outline" size={24} color={COLOR_PRIMARY_BLUE} />
